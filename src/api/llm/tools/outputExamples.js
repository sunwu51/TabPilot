...
export const BUILTIN_TOOL_OUTPUT_EXAMPLES = {
  ...
  memory_search: { success: true, query: "OpenCode free model decision", minScore: 6, count: 1, memories: [{ id: "mem_1", type: "decision", subject: "TabManager OpenCode free provider", summary: "Removed the unreliable provider after HTTP 429 errors", content: "Keyword summaries now use the active chat model by default.", keywords: ["free model", "HTTP 429"], entities: ["TabManager", "OpenCode"], scope: { kind: "project", value: "TabManager" }, importance: 0.9, score: 28.4, matchedBy: {} }] },
  memory_save: { success: true, action: "created", memory: { id: "mem_1", type: "preference", subject: "Response language", summary: "Prefer Chinese responses", content: "The user generally prefers communication in Chinese.", keywords: ["Chinese", "response language"], entities: [], scope: { kind: "global", value: "" }, importance: 0.8 } },
  memory_update: { success: true, memory: { id: "mem_1", type: "preference", subject: "Response language", summary: "Prefer concise Chinese responses" } },
  memory_delete: { success: true, id: "mem_1", removed: true },
