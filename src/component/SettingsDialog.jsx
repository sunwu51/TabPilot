...
const WS_BRIDGE_STATUS_STORAGE_KEY = "wsBridgeStatus";
const DEFAULT_WS_BRIDGE_STATUS = {
  state: "idle",
  url: "",
  error: "",
  updatedAt: 0,
...
function SettingsDialogBody() {
  ...
  const wsBridgeLastHeartbeat = formatStatusTime(wsBridgeStatus.lastHeartbeatAckAt);
...
function getWsBridgeStateMeta(state) {
  switch (state) {
    case "connected":
