...
const MESSAGES = {
  zh: {
    ...
    send: "发送",
    stop: "停止",
    reasoningDefault: "思考: 默认",
    reasoningLow: "思考: 低",
    reasoningMedium: "思考: 中",
    reasoningHigh: "思考: 高",
    reasoningXhigh: "思考: 超高",
    reasoningEffort: "思考强度",
    reasoningShortDefault: "默认",
    reasoningShortLow: "低",
    ...
    ,subscriptionUsageTitle: "Codex 订阅用量"
    ,subscriptionUsageUsed: "已用 {usage}"
    ,subscriptionUsageShortWindow: "短期窗口"
    ,subscriptionUsageLongWindow: "长期窗口"
    ,subscriptionUsageWindow: "{duration} 窗口"
    ,subscriptionUsageUsedPercent: "已用 {percent}"
    ,subscriptionUsageUnknownReset: "重置时间未知"
    ,subscriptionUsageResetPending: "已到重置时间，等待更新"
    ,subscriptionUsageResetsIn: "约 {duration}后重置"
    ,subscriptionUsageResetsInAt: "约 {duration}后重置 · {time}"
    ,subscriptionUsageNotQueried: "尚未查询"
    ,subscriptionUsageJustUpdated: "刚刚更新"
    ,subscriptionUsageUpdatedAgo: "{duration}前更新"
    ,subscriptionUsageMinutes: "{count} 分钟"
    ,subscriptionUsageHours: "{count} 小时"
    ,subscriptionUsageDays: "{count} 天"
    ,subscriptionUsageRefresh: "刷新"
    ,subscriptionUsageRefreshing: "查询中…"
    ,subscriptionUsageLoading: "正在查询用量…"
    ,subscriptionUsageEmpty: "暂无用量数据"
    ,subscriptionUsageWindowUnavailable: "窗口用量暂不可用"
    ,subscriptionUsageKeepStale: "保留上次数据"
    ,subscriptionUsageRetryLater: "请稍后重试"
    ,subscriptionUsageAccount: "账号：{account}"
    ,subscriptionUsageSignedIn: "已登录"
    ,subscriptionUsageQueryFailed: "无法查询订阅用量"
    ...
    ,supabaseHint: "会话按更新时间合并；设置由你明确选择恢复或覆盖远端。请使用 private Bucket；图片发送给 LLM 时会生成有效期 7 天的 signed URL。"
    ,syncSessions: "同步会话"
    ,restoreSettingsFromSupabase: "恢复远端设置"
    ,overwriteSupabaseSettings: "覆盖远端"
    ,supabaseWorking: "处理中..."
    ,confirmRestoreSettingsFromSupabase: "远端设置将完整覆盖当前本地设置。会话历史不受影响。确认恢复吗？"
    ,confirmOverwriteSupabaseSettings: "当前本地设置将完整覆盖 Supabase 中的设置。会话历史不受影响。确认覆盖吗？"
    ,supabaseSessionSyncComplete: "会话同步完成：上传 {uploaded}，下载 {downloaded}"
    ,supabaseSettingsRestoreComplete: "已从远端恢复设置"
    ,supabaseSettingsOverwriteComplete: "已用本地设置覆盖远端设置"
    ,supabaseSessionSyncFailed: "会话同步失败: {message}"
    ,supabaseSettingsRestoreFailed: "恢复远端设置失败: {message}"
    ,supabaseSettingsOverwriteFailed: "覆盖远端设置失败: {message}"
    ,feedback: "意见反馈"
    ...
    ,subagentSteps: "步"
    ,subagentFailed: "失败"
    ,subagentTemplates: "子 Agent 模板"
    ,subagentNoTemplates: "暂无模板"
    ,subagentEditTemplate: "编辑"
    ,subagentDeleteTemplate: "删除"
    ,subagentHideTemplateForm: "收起模板表单"
    ,subagentAddTemplate: "添加模板"
    ,subagentTemplateName: "模板名称"
    ,subagentTemplateNamePlaceholder: "research_assistant"
    ,subagentTemplateDescription: "模板介绍"
    ,subagentTemplateDescriptionPlaceholder: "研究并交叉核对多个来源的信息。"
    ,subagentTemplateInstructions: "指令"
    ,subagentTemplateInstructionsPlaceholder: "优先使用搜索工具并注明信息来源。"
    ,subagentAllowedBuiltinDomains: "允许的内置工具域"
    ,subagentAllowedMcpServers: "允许的 MCP Server"
    ,subagentNoConnectedMcpServers: "暂无已连接的 MCP Server"
    ,subagentEnableTemplate: "启用模板"
    ,subagentSaveTemplate: "保存"
    ,subagentSubmitTemplate: "添加"
    ,subagentTemplateNameRequired: "请填写模板名称"
    ,subagentTemplateDescriptionRequired: "请填写模板介绍"
    ,subagentTemplateSaved: "模板已保存"
    ,subagentTemplateSaveFailed: "保存模板失败: {message}"
    ,pendingLlmModelDraft: "LLM 模型"
    ,pendingImageModelDraft: "图片模型"
    ,pendingSubagentTemplateDraft: "子 Agent 模板"
    ,confirmDiscardSettingsDrafts: "有未保存的 {names} 草稿，确认要放弃这些草稿并保存其它设置吗？"
    ,memoryTitle: "Agent 长期记忆"
    ,memoryView: "查看记忆"
    ,memorySettingsHint: "只读查看和搜索 Agent 跨会话保存的长期记忆"
    ,memoryCountReadonly: "{count} 条 · 只读"
    ,memorySearchLabel: "搜索记忆"
    ,memorySearchPlaceholder: "搜索主题、内容、关键词"
    ,memoryAll: "全部"
    ,memoryNoMatches: "没有匹配的记忆"
    ,memorySelectHint: "选择一条记忆查看详情"
    ,memoryType: "类型"
    ...
    ,memoryKeywords: "关键词"
    ,memoryEntities: "实体"
    ,memoryScopeKind: "范围类型"
    ,memoryScopeValue: "范围值"
    ,memoryMetadata: "创建于 {created} · 更新于 {updated} · 确认 {count} 次"
    ,memoryReadFailed: "读取记忆失败: {message}"
    ,memoryType_preference: "偏好"
    ,memoryType_correction: "纠正"
    ,memoryType_decision: "决策"
    ,memoryType_workflow: "工作流"
    ,memoryType_entity: "实体"
    ,memoryType_reference: "参考"
  },
  en: {
    ...
    reasoningShortDefault: "Default",
    reasoningShortLow: "Low",
    ...
    ,subscriptionUsageTitle: "Codex subscription usage"
    ,subscriptionUsageUsed: "Used {usage}"
    ,subscriptionUsageShortWindow: "Short window"
    ,subscriptionUsageLongWindow: "Long window"
    ,subscriptionUsageWindow: "{duration} window"
    ,subscriptionUsageUsedPercent: "Used {percent}"
    ,subscriptionUsageUnknownReset: "Reset time unavailable"
    ,subscriptionUsageResetPending: "Reset time reached; waiting for an update"
    ,subscriptionUsageResetsIn: "Resets in about {duration}"
    ,subscriptionUsageResetsInAt: "Resets in about {duration} · at {time}"
    ,subscriptionUsageNotQueried: "Not queried yet"
    ,subscriptionUsageJustUpdated: "Updated just now"
    ,subscriptionUsageUpdatedAgo: "Updated {duration} ago"
    ,subscriptionUsageMinutes: "{count} min"
    ,subscriptionUsageHours: "{count} hr"
    ,subscriptionUsageDay: "{count} day"
    ,subscriptionUsageDays: "{count} days"
    ,subscriptionUsageRefresh: "Refresh"
    ,subscriptionUsageRefreshing: "Checking…"
    ,subscriptionUsageLoading: "Checking usage…"
    ,subscriptionUsageEmpty: "No usage data"
    ,subscriptionUsageWindowUnavailable: "Window usage unavailable"
    ,subscriptionUsageKeepStale: "showing the last successful result"
    ,subscriptionUsageRetryLater: "please try again later"
    ,subscriptionUsageAccount: "Account: {account}"
    ,subscriptionUsageSignedIn: "Signed in"
    ,subscriptionUsageQueryFailed: "Unable to query subscription usage"
    ...
    ,supabaseHint: "Sessions merge by update time; you explicitly choose whether to restore or overwrite settings. Use a private bucket; images receive a signed URL valid for 7 days when sent to the LLM."
    ,syncSessions: "Sync sessions"
    ,restoreSettingsFromSupabase: "Restore remote settings"
    ,overwriteSupabaseSettings: "Overwrite remote"
    ,supabaseWorking: "Working..."
    ,confirmRestoreSettingsFromSupabase: "Remote settings will completely replace local settings. Session history is not affected. Restore settings?"
    ,confirmOverwriteSupabaseSettings: "Local settings will completely replace the Supabase settings backup. Session history is not affected. Overwrite settings?"
    ,supabaseSessionSyncComplete: "Session sync complete: uploaded {uploaded}, downloaded {downloaded}"
    ,supabaseSettingsRestoreComplete: "Restored settings from remote"
    ,supabaseSettingsOverwriteComplete: "Overwrote remote settings with local settings"
    ,supabaseSessionSyncFailed: "Session sync failed: {message}"
    ,supabaseSettingsRestoreFailed: "Restore remote settings failed: {message}"
    ,supabaseSettingsOverwriteFailed: "Overwrite remote settings failed: {message}"
    ,feedback: "Feedback"
    ...
    ,subagentTemplates: "Sub-agent Templates"
    ,subagentNoTemplates: "No templates configured"
    ,subagentEditTemplate: "Edit"
    ,subagentDeleteTemplate: "Delete"
    ,subagentHideTemplateForm: "Hide Template Form"
    ,subagentAddTemplate: "Add Template"
    ,subagentTemplateName: "Template name"
    ,subagentTemplateNamePlaceholder: "research_assistant"
    ,subagentTemplateDescription: "Description"
    ,subagentTemplateDescriptionPlaceholder: "Research and cross-check information from multiple sources."
    ,subagentTemplateInstructions: "Instructions"
    ,subagentTemplateInstructionsPlaceholder: "Prefer search tools and cite your sources."
    ,subagentAllowedBuiltinDomains: "Allowed built-in tool domains"
    ,subagentAllowedMcpServers: "Allowed MCP servers"
    ,subagentNoConnectedMcpServers: "No connected MCP servers"
    ,subagentEnableTemplate: "Enable template"
    ,subagentSaveTemplate: "Save"
    ,subagentSubmitTemplate: "Add"
    ,subagentTemplateNameRequired: "Enter a template name"
    ,subagentTemplateDescriptionRequired: "Enter a template description"
    ,subagentTemplateSaved: "Template saved"
    ,subagentTemplateSaveFailed: "Failed to save template: {message}"
    ,pendingLlmModelDraft: "LLM model"
    ,pendingImageModelDraft: "image model"
    ,pendingSubagentTemplateDraft: "sub-agent template"
    ,confirmDiscardSettingsDrafts: "There are unsaved {names} drafts. Discard them and save the other settings?"
    ,memoryTitle: "Agent Memory"
    ,memoryView: "View Memory"
    ,memorySettingsHint: "View and search the agent's cross-session memory in read-only mode"
    ,memoryCountReadonly: "{count} items · Read only"
    ,memorySearchLabel: "Search memory"
    ,memorySearchPlaceholder: "Search subjects, content, or keywords"
    ,memoryAll: "All"
    ,memoryNoMatches: "No matching memories"
    ,memorySelectHint: "Select a memory to view its details"
    ,memoryType: "Type"
    ...
    ,memoryScopeKind: "Scope type"
    ,memoryScopeValue: "Scope value"
    ,memoryMetadata: "Created {created} · Updated {updated} · Confirmed {count} times"
    ,memoryReadFailed: "Failed to read memory: {message}"
    ,memoryType_preference: "Preference"
    ,memoryType_correction: "Correction"
    ,memoryType_decision: "Decision"
    ,memoryType_workflow: "Workflow"
    ,memoryType_entity: "Entity"
    ,memoryType_reference: "Reference"
  }
};
